...
public class TicTacToeGame {
	...
	/**
	 * @author jayeshkumar Displaying the board in 3*3 manner.
	 */
	...
	/**
	 * First checks if it can win. If it can win with next move it makes that move
	 * else chooses random index between 1 to 9
	 */
	...
	public char computerStratergy() {
		...
		if ((board[1] == ' ')
				&& ((board[2] == board[3]) && (board[2] == player2) || (board[4] == board[7]) && (board[4] == player2)
			...
			return 'y';
				...
				&& ((board[2] == board[1]) && (board[2] == player2) || (board[6] == board[9]) && (board[6] == player2)
			...
			return 'y';
				...
				|| (board[3] == board[7]) && (board[3] == player2) || (board[2] == board[8]) && (board[2] == player2)
			...
			return 'y';
				...
				&& ((board[1] == board[4]) && (board[1] == player2) || (board[8] == board[9]) && (board[8] == player2)
			...
			return 'y';
				...
				&& ((board[1] == board[5]) && (board[1] == player2) || (board[3] == board[6]) && (board[3] == player2)
	...
	public char canOpponentWin() {
		...
		if ((board[1] == ' ')
				&& ((board[2] == board[3]) && (board[2] == player1) || (board[4] == board[7]) && (board[4] == player1)
			...
			return 'y';
				...
				&& ((board[2] == board[1]) && (board[2] == player1) || (board[6] == board[9]) && (board[6] == player1)
			...
			return 'y';
				...
				|| (board[3] == board[7]) && (board[3] == player1) || (board[2] == board[8]) && (board[2] == player1)
			...
			return 'y';
				...
				&& ((board[1] == board[4]) && (board[1] == player1) || (board[8] == board[9]) && (board[8] == player1)
			...
			return 'y';
				...
				&& ((board[1] == board[5]) && (board[1] == player1) || (board[3] == board[6]) && (board[3] == player1)
	...
	/**
	 * @return X if user wins,returns O if computer wins,returns t if its a
	 *         tie,returns n if no winner and empty space available.
	 */
	public char isWins() {
